...
% Ubuntu:
dataset_path = '/home/yan/MA/Peeling_like/State_2/';
for n = 1:nbSamples
...
R = readtable('/home/yan/MA/Peeling_like/State_2/Test_2.txt', 'Delimiter', '\t');
refData = R{:, {'Xl_x', 'Xl_y', 'Xl_z', 'Vl_x', 'Vl_y', 'Vl_z'}}';
plot(refData(4,:)', '--','Color',[0 0 1], 'LineWidth',1); hold on;
plot(refData(5,:)', '--','Color',[1 0 0], 'LineWidth',1); hold on;
plot(refData(6,:)', '--','Color',[0 1 0], 'LineWidth',1); hold on;
