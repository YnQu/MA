...
% inputs:
% dataset : the data 2D or 3D chosen from main function
%           For example, '3D_Cshape_bottom.mat' is a 15x1 cell, which means
%           there are 16 trajectories. Each traj is a 6xN double, meaning
%           there would be N points 
% sub_sample : controls the step size 
% nb_trajectories : # of traj
...
% Processing for the 3D Datasets
    ...
    for l=1:nb_trajectories
        ...
        if dataset ==  11
            ...
            % data{l}: data is a cell array, l is the index
